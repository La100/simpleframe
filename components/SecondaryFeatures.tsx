...
import screenshotContacts from '../public/images/screenshots/3d.jpg'
import screenshotInventory from '../public/images/screenshots/3d2.jpg'
import screenshotProfitLoss from '../public/images/screenshots/3d3.png'

const features = [
  {
    name: 'Profesjonalizm i jakość',
  ...
  {
    name: 'Zwiększenie zaangażowania klientów',
    summary:
  ...
  {
    name: 'Dostosowanie do Twoich potrzeb',
    summary:
    ...
    >
      ...
      <h3
        className={clsx('mt-6 text-sm font-medium ', {
          'text-babyblue focus:outline-none ': isActive,
          'text-white': !isActive,
        })}
      >
        {feature.name}
      ...
      <Container>
        <div className="mx-auto max-w-2xl md:text-center">
          ...
          >
            ...
            Korzyści</span> ze współpracy
          </h2>
          <p className="mt-4 text-lg tracking-tight text-white">
          Zwiększenie efektywności, poprawa jakości produkcji oraz w realizacji projektów.
          </p>
        </div>
        <FeaturesMobile />
        <FeaturesDesktop />
